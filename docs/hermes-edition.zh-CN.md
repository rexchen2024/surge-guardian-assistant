...
```text
请从 https://github.com/rexchen2024/surge-guardian-assistant 安装 Surge Sentry，运行 setup，检查 Surge 环境，并显示生成的 Hermes cron 命令。确认命令前不要创建任务；未得到我确认前不要编辑 Surge profile、证书、DNS、服务器、MITM、Rewrite、Scripting、Replica，也不要执行 reload 或 restart。
```
