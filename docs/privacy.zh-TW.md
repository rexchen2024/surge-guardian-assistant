...
[简体中文](https://github.com/rexchen2024/surge-guardian-assistant/blob/main/docs/privacy.zh-CN.md) | [English](https://github.com/rexchen2024/surge-guardian-assistant/blob/main/docs/privacy.md)
...
- 分享前檢查截圖和終端日誌。
- 優先分享摘要，不要分享原始 dump。
- 每次提交前執行 `scripts/surge-guardian-assistant redact-check`。
